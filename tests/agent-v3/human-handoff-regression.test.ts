...
describe("Human handoff + initial greeting",()=>{
 ...
 it("padroniza saudação inicial sem emoji",()=>{expect(orchestrator).toContain("Aqui é a Júlia da Mind. Como posso te ajudar?");expect(orchestrator).toContain('Evite "Bem-vindo à Mind"')});
});
