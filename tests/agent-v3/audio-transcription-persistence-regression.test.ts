...
const webhook=fs.readFileSync("src/routes/api/public/hooks/uazapi-webhook.ts","utf8");const runtime=fs.readFileSync("src/lib/agent-v3/runtime.server.ts","utf8");const uazapi=fs.readFileSync("src/lib/uazapi.server.ts","utf8");const audioProcessor=fs.readFileSync("src/lib/agent-v3/integrations/audio-processor.server.ts","utf8");
