import type { LoadedModuleV3 } from "./modules.server";
...
export const KEYWORD_MAP: Record<string, string[]> = {
  ...
  facebook: ["facebook", "face "],
  x_twitter: ["twitter", "x "],
  pagamentos: ["pix", "pagar", "pagamento", "comprovante", "paguei", "fiz o pix", "saldo", "recarga"],
  tabela_precos: ["tabela", "preços", "lista", "valores", "quanto é", "qual o valor", "quanto", "valor", "preço", "custa", "quanto fica"],
