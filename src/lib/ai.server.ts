...
export async function generateAgentReplyWithMeta(params: {
  ...
  const system = [
    ...
    // Encerramento por recusa + regra de split: consolidados na identidade.
    ...
    // Regra de emoji: consolidada na identidade compartilhada.
    ...
    exposeFreeTrialBlock
      ...
      : "",
    // Teste grátis — regras de ouro: consolidadas na identidade compartilhada.
