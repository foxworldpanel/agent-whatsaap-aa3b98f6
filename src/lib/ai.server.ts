...
export async function generateAgentReplyWithMeta(params: {
  ...
  const system = [
    ...
    `SPOTIFY — DISPONIBILIDADE DE SERVIÇOS: NUNCA diga que um serviço do Spotify está "desativado" ou "em atualização" a menos que ele NÃO esteja listado na tabela_precos manual. Se o serviço (ex: plays, ouvintes, seguidores) aparece na tabela_precos, ele está DISPONÍVEL. Siga o preço e as regras da tabela_precos.`,
