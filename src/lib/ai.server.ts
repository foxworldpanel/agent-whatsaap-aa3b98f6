...
const MODULE_TRIGGERS: Array<{ rx: RegExp; modules: string[] }> = [
  ...
  { rx: /problema|n[aã]o funcionou|n[aã]o recebi|\batraso\b|suporte|ticket|reclama|refil/i, modules: ["suporte", "inteligencia_emocional"] },
...
Exemplo de final de resposta: "...aguardo seu retorno! [TEMP:morno]"`,
    ...
    `COMPROVANTE DE PAGAMENTO (PIX / CRYPTO) — REGRA ABSOLUTA:\n- Quando o cliente mandar um comprovante de PIX ou Crypto (imagem de transferência, recibo, print de pagamento), QUEM PAGOU JÁ TEM CADASTRO. NUNCA peça para "fazer cadastro", "criar conta" ou "se cadastrar" novamente.\n- Confirme o valor e oriente DIRETO para fazer o PEDIDO no painel (${agent.panel_link ?? "www.mindsmmpanel.com"}). O cadastro já foi feito antes do pagamento.`,
