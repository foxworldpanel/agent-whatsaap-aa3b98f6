...
export async function generateAgentReply(params: {
  ...
  const system = [
    ...
    servicesContext
      ? `CATÁLOGO DE SERVIÇOS DO PAINEL (atualizado agora — fonte oficial de preços e limites):\n${servicesContext}\n\nREGRAS DE PREÇO (OBRIGATÓRIAS):\n- Você TEM acesso à lista completa de serviços com preços e quantidades mínimas/máximas acima. NUNCA mande link de catálogo, tabela ou "mindsmmpanel.com/services" como resposta de preço — você já tem os dados, responda direto.\n- NUNCA confirme uma quantidade sem verificar o mínimo (min) do serviço no catálogo.\n- Cálculo: total = (rate / 1000) * quantidade.\n- Se o cliente pedir quantidade ABAIXO do mínimo, responda em uma frase única no formato: "O mínimo são [X], que sai R$[valor]" — nada além disso.\n- NUNCA diga que 100 plays é possível se o mínimo for 500. Sempre cite o mínimo real.\n- Só envie o link www.mindsmmpanel.com quando o cliente pedir para fazer o cadastro/pedido, nunca como resposta de preço.`
      : "",
