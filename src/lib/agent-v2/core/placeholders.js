...
`;
export const PANEL_V2 = `
# Módulo Painel Oficial
- Endereço do painel: painel.agenciamind.com
- Cadastro: O cliente deve clicar em "Cadastre-se" no topo da página.
- Login: Uso de email e senha cadastrados.
`;
...
# Módulo Tutoriais (Base)
Instruções passo a passo para o uso da plataforma.
`;
