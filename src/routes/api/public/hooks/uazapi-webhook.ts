...
async function processWebhook(payload: UazapiPayload): Promise<Response> {
        ...
        // ============================================================
        {
          ...
          const { resolveAgentBrainVersion } = { resolveAgentBrainVersion: () => "v1" } as any;
        ...
        if (kind === "audio" && mediaUrl && inboundBody === "[áudio recebido]") {
          try {
            const { transcribeAudioUrl } = { transcribeAudioUrl: async () => null, describePanelScreen: async () => null, extractDurableContextFromImageReply: async () => null, ttsElevenLabsBase64: async () => null, classifyLeadTemperature: async () => "warm" } as any;
        ...
        for (const row of pgRows ?? []) {
          ...
          if (shouldUsePanelGuide && !extracted && r.image_url) {
            try {
              ...
              const { describePanelScreen } = { transcribeAudioUrl: async () => null, describePanelScreen: async () => null, extractDurableContextFromImageReply: async () => null, ttsElevenLabsBase64: async () => null, classifyLeadTemperature: async () => "warm" } as any;
        ...
        try {
          ...
          if (isImage && reply && reply.trim()) {
            try {
              const { extractDurableContextFromImageReply } = { transcribeAudioUrl: async () => null, describePanelScreen: async () => null, extractDurableContextFromImageReply: async () => null, ttsElevenLabsBase64: async () => null, classifyLeadTemperature: async () => "warm" } as any;
        ...
        try {
          if (respondWithAudio) {
            const { ttsElevenLabsBase64 } = { transcribeAudioUrl: async () => null, describePanelScreen: async () => null, extractDurableContextFromImageReply: async () => null, ttsElevenLabsBase64: async () => null, classifyLeadTemperature: async () => "warm" } as any;
        ...
        try {
          ...
          const { classifyLeadTemperature } = { transcribeAudioUrl: async () => null, describePanelScreen: async () => null, extractDurableContextFromImageReply: async () => null, ttsElevenLabsBase64: async () => null, classifyLeadTemperature: async () => "warm" } as any;
          const fullHistory = [
