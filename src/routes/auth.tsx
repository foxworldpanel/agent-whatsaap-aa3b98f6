...
export const Route = createFileRoute("/auth")({
  ssr: false,
  head: () => ({ meta: [{ title: "Entrar · ZapAgent" }] }),
  component: AuthPage,
});
...
function AuthPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div
        className="w-full max-w-md rounded-2xl border border-border p-8"
      ...
      >
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-lg border border-border bg-card px-4 py-2.5 text-sm font-medium transition hover:bg-muted"
        >
