-- Preserve the wider fair stale-lock scan while retaining the Welcome Funnel
-- ownership fence introduced by the later safety hardening. Contended/blocked
-- oldest rows must not starve unrelated orphan locks.
