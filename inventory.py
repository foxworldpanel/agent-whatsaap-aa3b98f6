...
MIND_ID = "bd59fa41-d68d-4ac8-b995-e09ae48f52aa"
OTHER_ID = "a4c51e0c-2c39-486e-882b-032d056dfcfe"
...
for table in tables:
    query = f"SELECT count(*) FROM public.{table} WHERE workspace_id = '{OTHER_ID}';"
