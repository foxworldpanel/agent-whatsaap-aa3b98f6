...
const scenarios = [
  ...
  ["customer turn preserves chronological member order", turnRuntime.includes("for (const member of members)")],
  ["audio is resolved before semantic runtime", media.includes('member.contentKind === "audio"') || media.includes('contentKind === "audio"')],
  ["image is resolved before semantic runtime", media.includes('member.contentKind === "image"') || media.includes('contentKind === "image"')],
